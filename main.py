...
# Input nilai naik dan turun untuk setiap variabel
variabel = {}
for i in nama_var:
...
# Tampilkan data variabel yang dimasukkan
st.subheader("Data Variabel yang Dimasukkan:")
...
# Input nilai saat ini untuk setiap variabel (kecuali variabel yang ditanyakan)
soal = {}
